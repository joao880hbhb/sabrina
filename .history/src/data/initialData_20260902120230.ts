...
export const INITIAL_PRODUCTS: ProductSKU[] = [
  {
    ...
    minStockAlert: 30,
    imageUrl:
      "https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?w=300&auto=format&fit=crop&q=80",
    status: "active",
  ...
  },
  {
    ...
    minStockAlert: 20,
    imageUrl:
      "https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?w=300&auto=format&fit=crop&q=80",
    status: "active",
  ...
  },
  {
    ...
    minStockAlert: 30,
    imageUrl:
      "https://images.unsplash.com/photo-1598554747436-c9293d6a588f?w=300&auto=format&fit=crop&q=80",
    status: "active",
...
export const INITIAL_ORDERS: MarketplaceOrder[] = [
  ...
  },
  {
    ...
    suratJalanNomor: "SJP/JNT/20260901/002",
    notes:
      "PERINGATAN: Paket sudah diserahkan di Surat Jalan SJP/JNT/20260901/002 tapi belum tercatat scan ekspedisi > 24 jam! Siapkan klaim ganti rugi.",
  },
  {
    id: "ord-108",
    ...
    notes:
      "Paket telah selesai dipacking di gudang, menunggu pick-up kurir sore",
  },
  {
    id: "ord-104",
...
export const INITIAL_INVENTORY_TX: InventoryTransaction[] = [
  ...
  },
  {
    ...
    pic: "Pak Budi (Gudang)",
    notes:
      "Retur tukar size dari pembeli Medan, kondisi bersih dan hangtag utuh",
  },
  {
    id: "tx-007",
    ...
    notes:
      "Penyesuaian stok opname fisik: 2 pcs dialokasikan untuk sample photoshoot konten live",
  },
];
...
export const INITIAL_SURAT_JALAN: SuratJalan[] = [
  {
    ...
    pengirim: {
      ...
      signatureDataUrl:
        'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="160" height="70"><path d="M15 50 Q 35 15 65 45 T 115 25 T 145 50" stroke="%231e3a8a" stroke-width="2.5" fill="none"/></svg>',
    ...
    penerima: {
      ...
      signatureDataUrl:
        'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="160" height="70"><path d="M20 45 C 40 20, 60 60, 90 25 S 135 60, 150 35" stroke="%231e3a8a" stroke-width="2.5" fill="none"/></svg>',
    ...
    totalKoli: 3,
    catatan:
      "Serah terima paket pick-up sore Shopee Xpress. Total 3 paket dalam kantong karung tersegel.",
    status: "dikirim",
  },
  {
    id: "sjp-002",
    ...
    penerima: {
      ...
      signatureDataUrl:
        'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="160" height="70"><path d="M10 40 Q 30 10 50 40 T 90 20 T 110 45" stroke="%230f172a" stroke-width="2" fill="none"/></svg>',
    ...
    totalKoli: 2,
    catatan:
      "PERHATIAN: Resi JX8899001122 belum terscan oleh J&T setelah pick-up. Bukti TTD Pak Joko ada di surat jalan ini untuk klaim!",
    status: "dikirim",
  },
  {
    id: "sj-001",
    ...
    pengirim: {
      ...
      alamat: "Jl. R.E. Martadinata No. 128, Bandung, Jawa Barat",
      signatureDataUrl:
        'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="120" height="60"><path d="M10 40 Q 30 10 50 40 T 90 20 T 110 45" stroke="%230f172a" stroke-width="2" fill="none"/></svg>',
    },
    penerima: {
      nama: "Ibu Sabrina",
